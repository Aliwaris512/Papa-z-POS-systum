...
contextBridge.exposeInMainWorld('api', {
  ...
  addInventoryCategory: (name) => ipcRenderer.invoke('inventory:addCategory', name),
  adjustInventory: (payload) => ipcRenderer.invoke('inventory:adjust', payload),
  getInventoryHistory: (inventoryId) => ipcRenderer.invoke('inventory:getHistory', inventoryId),
